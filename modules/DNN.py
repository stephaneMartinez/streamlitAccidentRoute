...
EXPENDEUR_RESULTAT_DNN_MULTI = "Résultats DNN - Classification multiple"
EXPENDEUR_RESULTAT_DNN_BINARY = "Résultats DNN - Classification binaire"
EXPENDEUR_RESULTAT_DNN_STACKING_BINARY = "Résultats DNN Stacking (DNN+XGBoost+Régression Logistique) - Classification binaire"
EXPENDEUR_RESULTAT_DNN_MLPCLASSIFIER_BINARY = "Résultats DNN MLPClassifier - Classification binaire"

EXPENDEUR_ESTIMATION_MODELE = "Performances du modèle"

model_choices = {
    "DNN 10_8_6_4 (tanh+softmax) - classification multi classes (loss=sparse_categorial_crossentropy)": {
        'MODEL_FILE' : None,
        'TRAIN_RESULT' : constant.CHEMIN_IMAGE + "Resultats_DNN_10_tanh_multi.png",
        'TEST_RESULT' : constant.CHEMIN_IMAGE  + "Resultats_DNN_10_tanh_multi_test.png",
        'BINARY_MODEL' : False
    },
    "DNN 200_100_50_4 (tanh+softmax) - classification multi classes (loss=sparse_categorial_crossentropy)" : {
        'MODEL_FILE' : None,
        'TRAIN_RESULT' :  constant.CHEMIN_IMAGE + "Resultats_DNN_200_tanh_multi.png",
        'TEST_RESULT' : constant.CHEMIN_IMAGE + "Resultats_DNN_200_tanh_multi_test.png",
        'BINARY_MODEL' : False
    }, 
    "DNN 10_8_6_1 (tanh+sigmoid) - classification binaire (loss=binary_crossentropy)" : {
        'MODEL_FILE' : None,
        'TRAIN_RESULT' :  constant.CHEMIN_IMAGE + "Resultats_DNN_10_tanh_binary.png",
        'TEST_RESULT' : constant.CHEMIN_IMAGE + "Resultats_DNN_10_tanh_binary_test.png",
        'BINARY_MODEL' : True
    }, 
    "DNN 200_100_50_1 (tanh+sigmoid) - classification binaire (loss=binary_crossentropy)" : {
        'MODEL_FILE' : None,
        'TRAIN_RESULT' : constant.CHEMIN_IMAGE + "Resultats_DNN_200_tanh_binary.png",
        'TEST_RESULT' : constant.CHEMIN_IMAGE + "Resultats_DNN_200_tanh_binary_test.png",
        'BINARY_MODEL' : True
    }, 
    "(Stacked) DNN 200_100_50_1 (tanh+sigmoid) + XGBoost - classification binaire (loss=binary_crossentropy)" : {
        'MODEL_FILE' : None,
        'TRAIN_RESULT' :  constant.CHEMIN_IMAGE + "Resultats_DNN_Stacked_tanh_binary.png",
        'TEST_RESULT' : constant.CHEMIN_IMAGE + "Resultats_DNN_Stacked_tanh_binary_test.png",
        'BINARY_MODEL' : True
    }, 
    "MLPClassifier (200_100_50_1 activation=reLu) - classification binaire" : {
        'MODEL_FILE' : None,
        'TRAIN_RESULT' :  constant.CHEMIN_IMAGE + "Resultats_DNN_MLPClassifier_relu_binary.png",
        'TEST_RESULT' : constant.CHEMIN_IMAGE + "Resultats_DNN_MLPClassifier_relu_binary_test.png",
        'BINARY_MODEL' : True
    },     
}
...
def main():
    ...
    # HEADER
    # ------
    st.subheader('Modélisation de réseaux de neurones dense', anchor=False)
    ...
    if tabs == TAB_METHODOLOGIE :
        ...
        st.markdown(lb.DNN_INTRODUCTION, unsafe_allow_html=True)    

        show_space(1) 
        show_image(constant.CHEMIN_IMAGE + "DNN_schema_200_4.png")
        st.markdown(lb.DNN_EXEMPLE_RESEAU_MULI, unsafe_allow_html=True)   

        show_space(2)   
        show_image(constant.CHEMIN_IMAGE + "DNN_schema_10_1.png")
        st.markdown(lb.DNN_EXEMPLE_RESEAU_BINARY, unsafe_allow_html=True) 

        show_space(2)   
        show_image(constant.CHEMIN_IMAGE + "DNN_schema_Stacked_XGBoost_LR.png")
        st.markdown(lb.DNN_EXEMPLE_STACKED_BINARY, unsafe_allow_html=True) 

        show_space(2)   
        show_image(constant.CHEMIN_IMAGE + "DNN_schema_MLPClassifier.png")
        st.markdown(lb.DNN_EXEMPLE_MLPCLASSIFIER_BINARY, unsafe_allow_html=True) 



        show_space(1)   
        st.markdown(lb.DNN_DATAFRAME, unsafe_allow_html=True) 
        show_image(constant.CHEMIN_IMAGE + "DNN_DataFrame_SMOTE.png")
        ...
        show_space(1)
        st.markdown(lb.DNN_MLPCLASSIFIER, unsafe_allow_html=True) 
        show_space(1)
